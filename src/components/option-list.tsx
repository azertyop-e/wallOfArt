          ...
          >
            <label className="grid cursor-pointer grid-cols-[1fr_auto] items-center gap-x-gutter gap-y-2 py-5 text-xs leading-3 font-medium uppercase has-disabled:cursor-default has-disabled:opacity-40 md:grid-cols-6">
              ...
              <input
                ...
                className="col-start-2 row-start-2 size-3 cursor-pointer appearance-none transition-colors duration-300 justify-self-end border border-foreground outline-offset-4 checked:bg-foreground disabled:cursor-default md:col-start-6 md:row-start-1"
              />
            </label>
          </li>
        ))}
